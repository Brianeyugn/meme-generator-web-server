...
class ErrorRequestHandlerTest : public ::testing::Test {
    protected:
...
TEST_F(ErrorRequestHandlerTest, ValidErrorRequestWithBasePath) {
...
TEST_F(ErrorRequestHandlerTest, ValidErrorRequestWithIncorrectPath) {
    std::string method = "GET";
...
TEST_F(ErrorRequestHandlerTest, InvalidMethod) {
...
TEST_F(ErrorRequestHandlerTest, InvalidHttp) {
    std::string method = "GET";
    std::string requestURI = "/";
    std::string httpVersion = "HTTP/1.1";
    std::vector<std::string> headers = {"User-Agent: Mozilla/4.0 (compatible; MSIE5.01; Windows NT)", "Accept-Language: en-us"};
...
TEST_F(ErrorRequestHandlerTest, InvalidHeader) {
    std::string method = "GET";
    std::string requestURI = "/";
    std::string httpVersion = "HTTP/1.1";
    std::vector<std::string> headers = {"User-Agent: Mozilla/4.0 (compatible; MSIE5.01; Windows NT)", "Accept-Language: en-us"};
